...
export const ArtistHub: React.FC<ArtistHubProps> = ({ theme, themeStyles, phase, setPhase, language, currentUser = null, isArtist = false, onRequestSignIn, onExit, onThemeChange, onContextChange }) => {
    ...
    const [contracts, setContracts] = useState<HubContract[]>([
        { 
            ...
            requesterAvatar: '/media/Artistes/Tania.jpg',
            type: 'HELP_WANTED', 
            reward: 1, 
            duration: '1h', 
            tags: ['AUDIO', 'MIXING'],
        ...
        { 
            ...
            requesterAvatar: '/media/Artistes/Alex.jpg',
            type: 'HELP_WANTED', 
            reward: 1, 
            duration: '1h', 
            tags: ['DESIGN', 'VECTOR'],
        ...
        { 
            ...
            requesterAvatar: '/media/Artistes/Kyle.jpg',
            type: 'HELP_WANTED', 
            reward: 2, 
            duration: '2h', 
            tags: ['MUSIC', 'COLLAB'],
            status: 'OPEN',
            team: ['/media/Artistes/Sebastien.jpg']
        },
        { 
            id: 'C-04', 
            title: 'I have time for Grant Writing', 
            requester: 'Emilie G. Lavictoire', 
            requesterAvatar: '/media/Artistes/Emilie.jpg',
            type: 'TIME_TO_SPARE', 
            reward: 1, 
            duration: '1h', 
            tags: ['ADMIN', 'WRITING'],
                    ...
                    <div className={`relative w-full max-w-3xl max-h-[90vh] overflow-y-auto p-8 ${formStyles.container}`}
                        ...
                        <div className={`p-5 rounded-lg border-l-4 border-red-500 bg-red-500/5`}>
                            ...
                            <ul className="space-y-2 text-sm text-neutral-300 font-lato leading-relaxed">
                                ...
                                <li className="flex gap-2"><span className="font-mono text-red-300 tabular-nums">02</span><span>{language === 'EN' ? 'Application drafter: generates a first pass from your bio + project description.' : 'Brouilleur de demande : génère un premier jet à partir de votre bio + description du projet.'}</span></li>
                                <li className="flex gap-2"><span className="font-mono text-red-300 tabular-nums">03</span><span>{language === 'EN' ? 'Deadline tracker: pings you 3 weeks before each opportunity closes.' : 'Suivi des échéances : vous relance 3 semaines avant la fermeture de chaque appel.'}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className={`w-full min-h-[55svh] ${currentStyles.text} font-sans relative`}>
            ...
            <div 
                className={`z-40 sticky top-[66px] px-6 py-3 flex items-center justify-between bg-[#141414]/90 backdrop-blur-md border-b border-white/5`}
            >
                                            ...
                                            {!currentUser?.uid && (
                                                <p className="text-[11px] text-amber-300/80 mb-2 text-center">
                                                    {language === 'EN'
                                                        ...
                                                        : "Connectez-vous d'abord : les réponses arrivent sur votre profil."}
                                                </p>
                                            )}
                                            <button
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="font-lato text-neutral-400 max-w-2xl mx-auto">
                                        {language === 'EN'
                                            ...
                                            : "Caméras, éclairage, instruments, outils : listez ce que vous avez, empruntez ce qu'il vous faut. Le contact se fait en direct."}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className={`w-full max-w-2xl relative shadow-2xl max-h-[92vh] flex flex-col ${formStyles.container}`}>
                          ...
                          <div className="overflow-y-auto custom-scrollbar p-6 md:p-8">
                            <FormEditorialHeader
                                ...
                                leadFr="Un jeton équivaut à une heure. Demandez ce dont vous avez besoin ou offrez ce que vous avez ; le Salon orchestre l'échange."
                            />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        ...
                                        >
                                            ...
                                            <p className="text-[11px] opacity-70 font-lato leading-snug normal-case tracking-normal">
                                                {language === 'EN' ? 'Ask another member to spend their hour on your project.' : "Demandez à un·e membre de consacrer une heure à votre projet."}
                                            </p>
                                        </button>
                                        <button
                                            type="button"
                            ...
                            <div className={`relative w-full max-w-md p-6 ${formStyles.container}`} onClick={(e) => e.stopPropagation()}>
                                ...
                                <p className="text-xs text-neutral-400 leading-relaxed mb-5">
                                    {language === 'EN'
                                        ...
                                        : "Mettre ce skin en vente ouvre une enchère à partir de 1 pièce. Le skin quitte votre garde-robe jusqu'à la clôture : acceptez la meilleure offre pour conclure, ou annulez pour le récupérer."}
                                </p>
                            ...
                            >
                                ...
                                <p className="text-xs text-neutral-400 mb-4 leading-relaxed">
                                    {language === 'EN'
                                        ...
                                        : "Choisissez un·e ami·e ci-dessous. Il·elle recevra une offre ; si refusée, le casse-tête vous revient automatiquement."}
                                </p>
