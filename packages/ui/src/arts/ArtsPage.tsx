    ...
    return (
        <div className="w-full bg-[#0a0a0a] animate-fadeIn pb-32">
            ...
            <section className="relative min-h-screen flex items-center justify-center">
                <div aria-hidden className="absolute inset-0 pointer-events-none"><div className="sticky top-0 w-full bg-center bg-cover" style={{ height: '100vh', backgroundImage: `url("/media/Financement%20Artistique/kamy%20christina%20barcelona.jpg")` }} /></div>
