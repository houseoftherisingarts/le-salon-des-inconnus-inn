...
// The page scrolls inside <main> (overflow-y-auto), not the window; parallax
// must track that container or scrollYProgress never moves.
const ArtsScrollerContext = createContext<React.RefObject<HTMLElement> | null>(null);
  ...
  const FiscalityPage = () => {
    ...
    return (
        <div className="w-full bg-[#0a0a0a] animate-fadeIn pb-32">
            ...
            <section id="financing-section" className="relative min-h-screen flex flex-col items-center overflow-hidden py-24">
                <ParallaxBand img="/media/Financement%20Artistique/kamy%20inside.jpg" />
