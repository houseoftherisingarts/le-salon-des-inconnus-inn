...
// (règle d'Alex du 11 septembre : toujours en foil, sur tout site). Depuis le
// 14 septembre 2026, un clic ouvre une carte (calquée sur celle déjà en ligne
// du Collectif Sexe Positif) qui dit qui a bâti le site, avec le sous-titre
// « un projet du Salon des Inconnus » et le sigle doré du Salon en bas à
// droite. Le CSS du foil est inline ici plutôt que dans une feuille globale :
// ce fichier ne touche jamais index.css d'apps/salon.
...
const CollantVexel: React.FC<{ language: 'EN' | 'FR' }> = ({ language }) => {
                        ...
                        <div className="flex-1 p-6 md:p-10 flex flex-col relative">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p className="text-[13px] text-neutral-400 mt-1">{t('a project of Le Salon des Inconnus', 'un projet du Salon des Inconnus')}</p>
