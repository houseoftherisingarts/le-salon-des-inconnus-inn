...
// reveals the underlying color (flashlight) and ripples the surface.
//
...
//   • cn dependency dropped (was only used for className merging).
...
export const RevealWaveImage: React.FC<RevealWaveImageProps> = ({
    src,
    revealRadius = 0.2,
    revealSoftness = 0.5,
    pixelSize = 3,
