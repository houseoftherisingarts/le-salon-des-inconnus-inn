            ...
            {badges.exposes.map((id) => {
                ...
                return (
                    <span
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full border border-[#c5a059]/40 bg-black/40 backdrop-blur-md px-3 py-1 text-[10px] font-cinzel uppercase tracking-[0.14em] text-[#f3e5ab]"
                    >
                ...
                {obtenusIds.map((id) => {
                    ...
                    return (
                        <button
                            ...
                            className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-[10px] font-cinzel uppercase tracking-[0.14em] transition-colors disabled:opacity-40 ${
    ...
    return (
        <div className="mt-3">
            <button
                ...
                className="w-full py-2 text-[9px] font-cinzel uppercase tracking-[0.25em] border border-[#c5a059]/30 bg-[#c5a059]/5 text-[#c5a059] hover:bg-[#c5a059]/15 hover:border-[#c5a059]/60 rounded transition-colors"
            >
                    ...
                    {Object.values(CATALOGUE_BADGES).map((b) => {
                        ...
                        return (
                            <button
                                ...
                                title={language === 'EN' ? b.nomEn : b.nom}
                                className={`inline-flex items-center gap-1 rounded-full border px-2 py-1 text-[9px] font-cinzel uppercase tracking-wider transition-colors disabled:opacity-40 ${
