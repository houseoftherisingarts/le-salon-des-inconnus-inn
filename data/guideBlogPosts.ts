...
export const GUIDE_BLOG_POSTS: Record<string, BlogPost> = {
    ...
    'lac-plages': {
        _draft: true,
        intro_fr: "Lac-des-Plages porte bien son nom : un long lac bordé de plages discrètes, un village au charme rétro, et cette qualité particulière de lumière que l'on ne trouve nulle part ailleurs qu'au creux des Laurentides. C'est un coin que les locaux gardent un peu pour eux.",
