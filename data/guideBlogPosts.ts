...
export const GUIDE_BLOG_POSTS: Record<string, BlogPost> = {
    ...
    'petite-monnaie': {
        _draft: false,
        intro_fr: "La Petite Monnaie est la monnaie locale et communautaire de la Petite-Nation, dans la MRC de Papineau. Une petite-monnaie vaut un dollar canadien, et chaque billet dépensé reste dans la région : chez les artisans, les fermes, les cafés et les galeries qui font vivre la vallée. Plus de 150 commerces l'acceptent. Voici comment elle fonctionne, où s'en procurer, et la liste des commerces qui la prennent, du lac Simon jusqu'aux rives de l'Outaouais.",
        intro_en: "La Petite Monnaie is the local, community currency of the Petite-Nation, in the MRC de Papineau. One petite-monnaie is worth one Canadian dollar, and every note you spend stays in the region: with the artisans, farms, cafés and galleries that keep the valley alive. More than 150 businesses accept it. Here is how it works, where to get it, and the full list of merchants who take it, from Lac Simon down to the banks of the Ottawa River.",
        sections: [
            { title_fr: "Le concept, en clair", title_en: "The concept, plainly",
              body_fr: "La Petite Monnaie est portée par la Coopérative de solidarité Place du Marché, à Ripon. Une petite-monnaie égale un dollar canadien, et l'argent circule en boucle dans la Petite-Nation au lieu de filer vers les grandes chaînes. À chaque recharge, une bonification de 5 % s'ajoute à votre solde : payez 100 $, repartez avec 105 petites-monnaies. Plus de 150 commerces de la MRC de Papineau l'acceptent, et à Ripon, même une partie du salaire du maire est versée en petites-monnaies. C'est une économie de proximité, fondée sur la confiance, qui garde la richesse chez nous.",
              body_en: "La Petite Monnaie is run by the Coopérative de solidarité Place du Marché, in Ripon. One petite-monnaie equals one Canadian dollar, and the money loops back through the Petite-Nation instead of leaking out to big chains. Every time you top up, a 5 % bonus is added to your balance: pay 100 $, walk away with 105 petites-monnaies. More than 150 businesses across the MRC de Papineau accept it, and in Ripon, even part of the mayor's salary is paid in petites-monnaies. It is a trust-based local economy that keeps the wealth at home." },
            ...
            { title_fr: "Au Salon des Inconnus", title_en: "At Le Salon des Inconnus",
              body_fr: "Le Salon des Inconnus, à Namur, est l'un des onze bureaux de change. Procurez-vous vos premières petites-monnaies directement à l'auberge, prenez la carte de la région, et repartez avec un café barista, offert, à l'achat de votre enveloppe. De là, la Petite-Nation se descend de commerce en commerce, la petite-monnaie en poche.",
              body_en: "Le Salon des Inconnus, in Namur, is one of the eleven exchange points. Pick up your first petites-monnaies right at the inn, grab the regional map, and leave with a free barista coffee when you buy your envelope. From there, the Petite-Nation can be travelled shop by shop, petite-monnaie in hand." },
        ],
        faqs: [
    ...
    'plage-simon': {
        ...
        sections: [
            ...
            { title_fr: "À proximité", title_en: "Nearby",
              body_fr: "Le Salon des Inconnus est à quelques minutes en voiture. Une journée à la plage, puis un retour à l'auberge pour un souper traiteur ou une soirée musicale.",
              body_en: "Le Salon des Inconnus is a few minutes away by car. A day at the beach, then back to the inn for a catered supper or a musical evening." },
        ],
        faqs: [
    ...
    'tubes': {
        ...
        sections: [
            { title_fr: "L'art du slow floating", title_en: "The art of slow floating",
              body_fr: "Aucun moteur et aucune pagaie : le courant fait le travail. C'est ce qu'il faut pour une journée chaude où l'envie de bouger est moindre que celle de regarder le ciel défiler entre les arbres.",
              body_en: "No motor and no paddle: the current does the work. It suits a hot day when watching the sky drift past the trees beats moving." },
            ...
            { title_fr: "À proximité", title_en: "Nearby",
              body_fr: "Combinez la descente avec un passage par la plage du lac Simon ou un souper à l'Auberge, et la journée est pleine.",
              body_en: "Pair the float with a stop at the Lac Simon beach or a supper at the Inn, and the day is full." },
        ],
        faqs: [
    ...
    'lac-plages': {
        ...
        sections: [
            { title_fr: "Le lieu", title_en: "The place",
              body_fr: "Cherchez les accès plus discrets : quelques rampes de mise à l'eau, des plages publiques moins fréquentées, et des sentiers qui longent l'eau. Le village a un dépanneur et un restaurant, et pas grand-chose de plus.",
              body_en: "Look for the quieter access points: a few boat ramps, lesser-known public beaches, and paths along the water. The village has a corner store and a restaurant, and not much else." },
    ...
    'lac-croche': {
        ...
        sections: [
            ...
            { title_fr: "Esprit du lieu", title_en: "Spirit of the place",
              body_fr: "Le lac est silencieux. Les gens y viennent pour lire, ou pour ne rien faire du tout. Respectez la nature : pas de feu, pas de déchets.",
              body_en: "The lake is quiet. People come to read, or to do nothing at all. Respect the land: no fires, no trash left behind." },
        ],
    ...
    'ile-raisin': {
        _draft: true,
        intro_fr: "L'Île au Raisin, sur le lac Gagnon, est le genre d'endroit dont on parle à voix basse. Plus sauvage que les plages publiques, accessible en canot ou kayak, elle offre une eau claire, du sable blanc et pas un rivage habité en vue.",
        intro_en: "Île au Raisin, on Lac Gagnon, is the kind of place people talk about in low voices. Wilder than the public beaches, reached by canoe or kayak, it has clear water, white sand, and not a single populated shore in sight.",
        sections: [
            { title_fr: "S'y rendre", title_en: "Getting there",
    ...
    'montagnes-noires': {
        _draft: true,
        intro_fr: "Le Parc des Montagnes Noires de Ripon est le grand parc de randonnée de la Petite-Nation : 800 acres de forêt municipale, 25 km de sentiers, et une tour d'observation de 12 mètres perchée à 426 mètres d'altitude qui ouvre une vue à 360° sur toute la vallée.",
        intro_en: "The Parc des Montagnes Noires in Ripon is the big hiking park of Petite-Nation: 800 acres of municipal forest, 25 km of trails, and a 12-metre observation tower perched at 426 metres altitude that opens a 360° view over the entire valley.",
        sections: [
    ...
    'iroquois': {
        _draft: true,
        intro_fr: "Le sentier de la rivière Iroquois est une marche facile le long d'une rivière qui coule entre les pierres, sous une forêt assez dense pour qu'on n'entende plus grand-chose d'autre que l'eau.",
        intro_en: "The Rivière Iroquois trail is an easy walk along a river running between stones, under a forest dense enough that you hear little besides the water.",
        sections: [
            ...
            { title_fr: "L'idée", title_en: "The idea",
              body_fr: "L'été, combinez la marche et un bain rapide dans la rivière.",
              body_en: "In summer, combine the walk with a quick swim in the river." },
        ],
    ...
    'papineau': {
        ...
        sections: [
            { title_fr: "Le lieu", title_en: "The place",
              body_fr: "Lieu historique national administré par Parcs Canada, le manoir abrite des pièces d'époque, des collections, et raconte l'histoire d'une famille prise dans les bouleversements politiques du Bas-Canada.",
              body_en: "A National Historic Site administered by Parks Canada, the manor houses period rooms, collections, and tells the story of a family caught up in Lower Canada's political upheavals." },
    ...
    'barclay': {
        ...
        sections: [
            { title_fr: "Ce qui s'y passe", title_en: "What happens",
              body_fr: "Démonstrations de tournage, cuissons publiques, pièces uniques à acquérir, et rencontres directes avec les artistes. On y voit un savoir-faire qui ne s'apprend pas dans les livres, et on repart souvent avec une pièce.",
              body_en: "Throwing demonstrations, public firings, unique pieces for sale, and direct conversations with the artists. You watch a skill that isn't learned from books, and you often leave with a piece." },
        ],
    ...
    'michelle-lemire': {
        ...
        sections: [
            ...
            { title_fr: "Pourquoi y aller", title_en: "Why go",
              body_fr: "Pour rencontrer une artiste qui parle de son travail avec une rare précision, et repartir avec une pièce dont on connaît l'origine.",
              body_en: "To meet an artist who speaks about her work with rare precision, and leave with a piece whose origin you know." },
        ],
    ...
    'orties': {
        _draft: true,
        intro_fr: "Le Café des Orties est l'endroit où la Petite-Nation se retrouve. Installé dans un ancien presbytère de Ripon, il sert de café, de table et de galerie d'art, et les conversations y durent plus longtemps que le café.",
        intro_en: "Le Café des Orties is where Petite-Nation meets. Set up in a former presbytery in Ripon, it works as a café, a dining room and an art gallery, and the conversations outlast the coffee.",
        sections: [
            { title_fr: "La table", title_en: "The food",
              body_fr: "Mets bio de producteurs locaux, vins naturels, cidres artisanaux. La carte change avec les saisons et suit ce que la région offre à ce moment-là.",
              body_en: "Organic dishes from local producers, natural wines, artisanal ciders. The menu shifts with the seasons and follows what the region offers at that moment." },
            ...
            { title_fr: "Pourquoi c'est unique", title_en: "Why it's unique",
              body_fr: "Il n'y a pas d'équivalent dans la région. Le produit est bon, les gens qui le font habitent à côté, et personne n'y joue un rôle.",
              body_en: "There's no equivalent in the region. The product is good, the people making it live next door, and nobody is performing." },
        ],
        faqs: [
    ...
    'napoleon': {
        ...
        sections: [
            { title_fr: "La cuisine", title_en: "The cooking",
              body_fr: "Les produits viennent des fermes du coin et suivent la saison. Le service est attentif et la carte évolue avec l'année. C'est le genre d'endroit où chaque assiette est pensée, et où on le sent.",
              body_en: "The produce comes from nearby farms and follows the season. Service is attentive and the menu shifts with the year. The kind of place where every plate is considered, and you can feel it." },
    ...
    'boulanger': {
        _draft: true,
        intro_fr: "À Montpellier, Mélissa et Julien moulent leur propre farine de grains biologiques et cuisent des miches au levain sur commande. La Fille du Boulanger est ouverte vendredi et samedi, et le village s'y donne rendez-vous.",
        intro_en: "In Montpellier, Mélissa and Julien mill their own flour from organic grains and bake sourdough loaves to order. La Fille du Boulanger is open Fridays and Saturdays, and the village meets there.",
        sections: [
            { title_fr: "Le pain", title_en: "The bread",
              body_fr: "Levain naturel, farines fraîchement moulues, cuissons au four à bois. Les miches ont une croûte épaisse, une mie alvéolée, une fermentation qu'on sent dès la première bouchée. Ce pain se garde plusieurs jours et voyage bien.",
              body_en: "Natural sourdough, freshly milled flours, wood-oven baked. The loaves have a thick crust, an open crumb, a fermentation you taste at first bite. It keeps for days and travels well." },
    ...
    'pommes': {
        _draft: true,
        intro_fr: "Les Pommes Perdues, à Chénéville, est le projet de Julien Robert et Gilbert Bégin : une quête patiente pour retrouver, fermenter et embouteiller les pommes oubliées du Québec. Leurs cidres sont vifs et sauvages.",
        intro_en: "Les Pommes Perdues, in Chénéville, is the project of Julien Robert and Gilbert Bégin: a patient quest to find, ferment, and bottle Quebec's forgotten apples. Their ciders are sharp and wild.",
        sections: [
            { title_fr: "La démarche", title_en: "The approach",
              body_fr: "Pommes anciennes, levures sauvages, fermentations longues. Chaque cuvée a sa propre signature. Ça demande du temps.",
              body_en: "Heritage apples, wild yeasts, long fermentations. Each cuvée has its own signature. It takes time." },
    ...
    'medieval': {
        ...
        sections: [
            ...
            { title_fr: "À 15 minutes de l'Auberge", title_en: "15 minutes from the Inn",
              body_fr: "Le Salon des Inconnus se trouve à un quart d'heure de route. Beaucoup de festivaliers logent à l'Auberge le temps du week-end : ils reviennent le soir d'un banquet, prennent un dernier verre au coin du feu et repartent le lendemain pour les joutes.",
              body_en: "Le Salon des Inconnus is a fifteen-minute drive away. Many festival-goers stay at the Inn for the weekend: they come back in the evening from a banquet, share a last drink by the fire, and head out again the next morning for the jousts." },
        ],
        faqs: [
    ...
    'mechoui': {
        _draft: true,
        intro_fr: "Le Méchoui de Montpellier est une fête populaire bruyante, pleine de fumée et de musique. Chaque été, tout le village s'arrête pour ce repas collectif.",
        intro_en: "The Méchoui de Montpellier is a noisy popular feast, full of smoke and music. Every summer, the entire village comes to a halt for this shared meal.",
        sections: [
            ...
            { title_fr: "Pourquoi y aller", title_en: "Why go",
              body_fr: "Vous y croiserez des agriculteurs, des artistes, des retraités et des jeunes familles : tout Montpellier en une après-midi.",
              body_en: "You'll meet farmers, artists, retirees and young families: all of Montpellier in a single afternoon." },
        ],
    ...
    'rodeo': {
        ...
        sections: [
            ...
            { title_fr: "L'ambiance", title_en: "The atmosphere",
              body_fr: "Musique country sous chapiteau, ambiance familiale en journée et plus festive en soirée. Un côté du Québec rural que les visiteurs ne soupçonnent pas toujours.",
              body_en: "Country music under the big top, family-friendly during the day and more festive in the evenings. A side of rural Quebec visitors don't always suspect." },
        ],
    ...
    'peche-blanche': {
        _draft: true,
        intro_fr: "En février, le lac Simon gelé se couvre de cabanes de pêche colorées. Le Tournoi de Pêche Blanche rassemble pêcheurs locaux et visiteurs sur la glace pour un week-end.",
        intro_en: "In February, frozen Lac Simon becomes a field of colourful fishing huts. The Tournoi de Pêche Blanche brings local anglers and visitors together on the ice for a weekend.",
        sections: [
            ...
            { title_fr: "L'ambiance", title_en: "The atmosphere",
              body_fr: "C'est aussi social que sportif. Entre deux ouvertures de trous, on partage un café, une bière, une histoire de pêche.",
              body_en: "It's as social as it is sporting. Between drilling holes, you share a coffee, a beer, a fishing story." },
        ],
    ...
    'meute': {
        _draft: true,
        intro_fr: "La Meute Tanwen, à Montpellier, c'est la meute de huskies sibériens d'Éric Pichette. Vous pilotez vous-même un attelage de quatre chiens à travers les sentiers forestiers vallonnés.",
        intro_en: "Meute Tanwen, in Montpellier, is Éric Pichette's pack of Siberian huskies. You drive a four-dog team yourself through rolling forest trails.",
        sections: [
            { title_fr: "L'expérience", title_en: "The experience",
              body_fr: "Briefing, harnachement, et c'est parti pour une heure de course en forêt. Les chiens tirent avec une joie pure; le contact avec les chiens est immédiat. Rien n'est mis en scène.",
              body_en: "Briefing, harnessing, and off you go for an hour of forest running. The dogs pull with pure joy; the contact with the dogs is immediate. Nothing is staged." },
            { title_fr: "Pourquoi y aller", title_en: "Why go",
              body_fr: "Aucune autre activité hivernale de la région n'a cette intensité, et Éric et son équipe traitent les chiens avec un respect qui se voit tout de suite.",
              body_en: "No other winter activity in the region has this intensity, and Éric and his team treat the dogs with a respect you notice right away." },
            { title_fr: "Pratique", title_en: "Practical info",
    ...
    'patin': {
        _draft: true,
        intro_fr: "Quand le lac Simon gèle à cœur, il devient un terrain de jeu immense. Sentier de patin balisé sur des kilomètres, glissades naturelles dans les talus enneigés, grands espaces blancs où le vent siffle.",
        intro_en: "When Lac Simon freezes through, it becomes a huge playground. A marked skating trail running for kilometres, natural sliding hills in the snowy banks, vast white expanses where the wind whistles.",
        sections: [
            ...
            { title_fr: "Au-delà du patin", title_en: "Beyond skating",
              body_fr: "Glissades, ski de fond improvisé, observation des chevreuils en lisière de forêt.",
              body_en: "Sliding, improvised cross-country skiing, deer-watching at the forest's edge." },
        ],
    ...
    'namur': {
        _draft: true,
        intro_fr: "La patinoire de Namur est la plus tranquille des patinoires de la région. Petite, peu fréquentée, entretenue par la communauté. On y patine seul ou avec les enfants, sans foule.",
        intro_en: "The Namur skating rink is the quietest in the region. Small, lightly used, community-maintained. You skate alone or with the kids, and there is no crowd.",
        sections: [
            { title_fr: "Le lieu", title_en: "The place",
              body_fr: "Glace soignée, éclairage nocturne, banc d'accueil. Aucun service ni commerce attenant, donc apportez ce qu'il vous faut.",
              body_en: "Well-kept ice, night lighting, a welcome bench. No services and no shops attached, so bring what you need." },
        ],
    ...
    'chevreuils': {
        _draft: true,
        intro_fr: "Prendre son café le matin en regardant par la fenêtre, voir les chevreuils traverser la propriété dans la neige fraîche, et ne plus bouger. Ça arrive souvent en Petite-Nation.",
        intro_en: "Drinking your morning coffee by the window, watching deer cross the property in fresh snow, and not moving. It happens often in Petite-Nation.",
        sections: [
            { title_fr: "Où et quand", title_en: "Where and when",
              body_fr: "Tout au long de l'hiver, les chevreuils circulent à travers les propriétés forestières de Duhamel et des villages alentours. Tôt le matin et en fin de journée sont les meilleurs moments. Restez à l'intérieur et attendez.",
              body_en: "All winter, deer move through the forest properties of Duhamel and the surrounding villages. Early morning and late afternoon are best. Stay inside and wait." },
        ],
        schema: { type: "TouristAttraction", address: "Duhamel, QC, Canada" },
    },
    ...
    'ti-mousse': {
        _draft: true,
        intro_fr: "Depuis 1977, l'Érablière chez Ti-Mousse, à Papineauville, fait du printemps québécois ce qu'il devrait être : un repas traditionnel à volonté, de la tire sur la neige, des balades en traîneau à chevaux, et l'odeur du sirop d'érable qui imprègne tout.",
        intro_en: "Since 1977, Érablière chez Ti-Mousse in Papineauville has made Quebec spring exactly what it should be: a traditional all-you-can-eat meal, taffy on snow, horse-drawn sleigh rides, and the smell of maple syrup soaked into everything.",
        sections: [
            { title_fr: "Le repas", title_en: "The meal",
              body_fr: "Soupe aux pois, fèves au lard, oreilles de crisse, jambon à l'érable, omelettes, crêpes, tartes au sirop. C'est copieux, ce qui est le but après une matinée passée dans la cabane à sucre.",
              body_en: "Pea soup, baked beans, crispy pork rinds, maple ham, omelettes, pancakes, syrup pies. It is filling, which is the point after a morning spent in the sugar shack." },
            { title_fr: "Le rituel", title_en: "The ritual",
              body_fr: "On termine par la tire sur la neige : du sirop bouilli versé sur la neige fraîche, qu'on enroule autour d'un bâton.",
              body_en: "You finish with maple taffy: boiled syrup poured on fresh snow and rolled onto a stick." },
    ...
    'agricola': {
        ...
        sections: [
            { title_fr: "L'ASC", title_en: "The CSA",
              body_fr: "Paniers hebdomadaires de saison, à récupérer sur place ou dans plusieurs points de chute.",
              body_en: "Weekly seasonal baskets, pickup on site or at several drop-off points." },
    ...
    'vezeau': {
        _draft: true,
        intro_fr: "Le Domaine Mont-Vézeau, à Ripon, c'est 9 000 pieds de vigne, deux hectares de fraises, des framboises, et (peut-être le meilleur) des pizzas au feu de bois servies sur la terrasse les fins de semaine.",
        intro_en: "Domaine Mont-Vézeau, in Ripon, is 9,000 grape vines, two hectares of strawberries, raspberries, and (maybe best of all) wood-fired pizzas served on the terrace on weekends.",
        sections: [
            ...
            { title_fr: "L'autocueillette", title_en: "Pick-your-own",
              body_fr: "Fraises et framboises en saison. Bonne sortie de famille un matin d'été.",
              body_en: "Strawberries and raspberries in season. A good family outing on a summer morning." },
    ...
    'presquile': {
        _draft: true,
        intro_fr: "Le Parc national de Plaisance, sur la rivière des Outaouais, est un sanctuaire d'oiseaux : 265 espèces recensées, des migrations printanières spectaculaires de bernaches, et des sentiers en milieu humide qui donnent sur les marais de la vallée.",
        intro_en: "Parc national de Plaisance, on the Ottawa River, is a bird sanctuary: 265 recorded species, spectacular spring goose migrations, and wetland trails looking out over the valley's marshes.",
        sections: [
            { title_fr: "Les migrations", title_en: "The migrations",
              body_fr: "Au printemps, des milliers de bernaches font escale dans les marais du parc. Le spectacle est sonore autant que visuel.",
              body_en: "In spring, thousands of Canada geese stop in the park's marshes. The spectacle is as loud as it is visual." },
            { title_fr: "Sur place", title_en: "On site",
    ...
    'omega': {
        _draft: true,
        intro_fr: "Le Parc Omega, à Montebello, est un sanctuaire animalier de 2 200 acres traversé par un parcours de 12 kilomètres en voiture, où vous croisez élans, bisons, loups, cerfs et ours noirs dans un environnement qui ressemble à leur habitat naturel.",
        intro_en: "Parc Omega in Montebello is a 2,200-acre animal sanctuary crossed by a 12-kilometre drive-through circuit where you encounter elk, bison, wolves, deer, and black bears in an environment that resembles their natural habitat.",
        sections: [
            ...
            { title_fr: "ONIRO, la nuit", title_en: "ONIRO, by night",
              body_fr: "En soirée, ONIRO transforme une partie du parc en parcours piétonnier nocturne illuminé. La forêt est éclairée et les animaux se voient autrement qu'en plein jour.",
              body_en: "At night, ONIRO turns part of the park into a lit pedestrian night walk. The forest is lit, and the animals look different than they do by day." },
            { title_fr: "Pratique", title_en: "Practical info",
    ...
    'centre-de-vie': {
        _draft: true,
        intro_fr: "Le Centre de Vie, à Ripon, est un centre de retraite bien-être posé sur 108 acres de forêt : yoga, naturopathie, massothérapie, méditation, cures de jus, programmes de jeûne. Lac privé, sentiers en forêt, repas végétariens, sauna, et des espaces de repos avec foyers, à quelques minutes de l'Auberge.",
        intro_en: "Centre de Vie, in Ripon, is a wellness retreat centre sitting on 108 acres of forest: yoga, naturopathy, massage therapy, meditation, juice cleanses, fasting programs. Private lake, forest trails, vegetarian meals, sauna, and rest spaces with fireplaces, a few minutes from the Inn.",
        sections: [
            ...
            { title_fr: "Combiner avec l'Auberge", title_en: "Combine with the Inn",
              body_fr: "Plusieurs visiteurs alternent : nuits à l'Auberge, journées au Centre.",
              body_en: "Many visitors alternate: nights at the Inn, days at the Centre." },
        ],
