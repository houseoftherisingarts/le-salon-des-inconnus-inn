...
export const GUIDE_BLOG_POSTS: Record<string, BlogPost> = {
    ...
    'tubes': {
        _draft: true,
        intro_fr: "Descendre la rivière Petite-Nation sur un tube est l'un des rituels d'été les plus discrets (et les plus québécois) de la région. À Duhamel, installez-vous sur un tube gonflable, lâchez prise, et le courant vous porte à travers la forêt pendant une heure ou deux.",
    ...
    'lac-croche': {
        _draft: true,
        intro_fr: "Le lac Croche, à Montpellier, est un de ces petits lacs forestiers connus surtout par tradition orale. Ni site touristique, ni plage organisée : juste un plan d'eau silencieux, entouré de forêt, où le bruit le plus fort est celui d'un huard à la fin de la journée.",
    ...
    'orties': {
        _draft: true,
        intro_fr: "Le Café des Orties, c'est le vrai cœur de la Petite-Nation. Installé dans un ancien presbytère de Ripon, c'est à la fois café, table à manger, galerie d'art, lieu de rencontre et carrefour intellectuel. Venez pour le café, restez pour les conversations.",
    ...
    'medieval': {
        ...
        sections: [
            ...
            { title_fr: "L'esprit du lieu", title_en: "The spirit of the place",
              body_fr: "Le FMM est porté par une équipe bénévole, ce qui transparaît dans chaque détail : l'attention portée aux costumes, la précision des reconstitutions, la chaleur de l'accueil. C'est un festival de communauté avant d'être un festival de scène : on y participe autant qu'on y regarde, pour ainsi dire à parts égales.",
