    ...
    'medieval': {
        ...
        sections: [
            ...
            { title_fr: "L'esprit du lieu", title_en: "The spirit of the place",
              body_fr: "Le FMM est porté par une équipe bénévole, ce qui transparaît dans chaque détail : l'attention portée aux costumes, la précision des reconstitutions, la chaleur de l'accueil. C'est un festival de communauté avant d'être un festival de scène : les visiteurs y participent autant qu'ils y regardent.",
