...
export const AdminCRM: React.FC<AdminCRMProps> = ({ language, onNavigate, user }) => {
  ...
  // Sidebar nav. Inline SVG paths instead of an icon dependency — keeps the
  // bundle slim and matches the existing icon style throughout the project.
  const nav: AdminNavItem<SectionId>[] = [
