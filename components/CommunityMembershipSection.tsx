...
const LETTER: { fr: string; en: string }[] = [
  ...
  {
    fr: "Le Salon des Inconnus, c'est une petite communauté grandissante, enracinée dans une auberge familiale. Il y a des membres permanents qui vivent sur place, et des membres comètes qui passent, laissent leur trace, puis repartent. L'auberge, c'est la business qui nous fait vivre ; et en retour, la communauté prend soin de l'auberge et la fait vivre.",
    en: "Le Salon des Inconnus is a small, growing community rooted in a family inn. There are permanent members who live on site, and comet members who pass through, leave their mark, then move on. The inn is the business that makes our living; and in return, the community takes care of the inn and keeps it alive.",
  },
  {
  ...
  {
    fr: "C'est un vrai travail. La tâche principale, c'est le ménage des chambres et des espaces communs, et c'est ce que nos invités remarquent en premier. C'est répétitif, c'est physique, et ça compte. À ça s'ajoutent des moments où vous tenez le fort quand nous sommes partis : accueillir des invités, être là pour les enfants de temps en temps. Et puis il y a les tâches partagées entre membres parce que nous vivons ensemble : arroser le jardin, donner un coup de main à la cuisine, la vie de tous les jours.",
    en: "This is real work. The main task is housekeeping the rooms and common spaces, and it is the first thing our guests notice. It's repetitive, it's physical, and it matters. On top of that, there are moments where you hold the fort while we're away: welcoming guests, being there for the kids now and then. And there are the tasks members share because we live together: watering the garden, lending a hand in the kitchen, the everyday.",
  },
  {
    fr: "Nous offrons un salaire au-dessus du wwoofing communautaire, en plus des avantages, parce que soutenir ce projet, c'est un vrai métier. Nous voulons que chaque personne qui vient greffer un peu de son âme à ce projet de rayonnement se sente appréciée à sa juste valeur. En même temps, le communautaire est au centre de la raison d'être de cet espace, et la personne qui vient en fait partie. C'est pour ça que l'approche hybride nous semble la plus juste : une sécurité de base et un salaire de base, tout en gardant à la personne la liberté de maintenir sa propre activité économique (idéal pour les nomades numériques).",
    en: "We offer a wage above community wwoofing, plus the perks, because supporting this project is a real craft. We want everyone who comes to graft a bit of their soul onto this living place to feel valued at their true worth. At the same time, the community is the very reason this space exists, and whoever comes joins it. That's why a hybrid approach feels truest to us: a base of security and a base wage, while leaving the person free to keep their own economic activity going (ideal for digital nomads).",
  },
  {
  ...
  {
    fr: "Côté humain, quelques essentiels comptent pour nous : une communication saine et honnête (savoir nommer les choses, écouter, désamorcer une tension), une certaine légèreté de l'être, l'amour des enfants (il y en a, et ils courent partout), et le goût de cuisiner. D'ailleurs, si la cuisine vous tente, sachez qu'en cuisinant pour la maisonnée vous êtes aussi nourri·e gratuitement.",
  ...
  {
    fr: "Et vous pouvez attendre exactement la même chose de notre part : le même soin dans la communication et le même engagement à se parler pour vrai.",
    en: "And you can expect exactly the same from us: the same care in communication and the same commitment to talking things through honestly.",
  },
];
...
export const CommunityMembershipSection: React.FC<Props> = ({
  ...
  const TERMS = [
    ...
    { v: t('Meals', 'Repas'), l: t('fed when you cook', 'nourri·e si vous cuisinez') },
    { v: t('Your time', 'Votre temps'), l: t('time and space for your projects', 'du temps et de l\'espace pour vos projets') },
