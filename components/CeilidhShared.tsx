...
export const TEAMS: CeilidhTeamData[] = [
  ...
  { id: 'jardins',    name: 'Garden Team',          name_fr: 'Team Jardins',           emoji: '🌱', maxMembers: 4,
    description: 'Tilling, weeding, planting, tending the greenhouse.',
