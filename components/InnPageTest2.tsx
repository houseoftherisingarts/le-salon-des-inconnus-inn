      ...
      <section className="relative min-h-screen overflow-hidden bg-[#050505]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto min-h-screen flex items-center px-8 md:px-16 lg:px-24 py-20">
          <div className="max-w-md reveal-on-load">
            ...
            >
              {t(
                'A Victorian manor on five forested acres in Namur, ten minutes from Lac Simon. We restored it room by room, preserving the bones, layering in art, music, food, and the quiet space artists need to make work that matters.',
                'Un manoir victorien sur cinq acres boisés à Namur, à dix minutes du Lac Simon. Nous l\'avons restauré pièce par pièce, préservant les os, ajoutant l\'art, la musique, la nourriture et l\'espace silencieux dont les artistes ont besoin pour créer.',
              )}
            </p>
            <button
