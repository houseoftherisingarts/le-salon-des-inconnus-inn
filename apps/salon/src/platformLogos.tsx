...
const AirbnbLogo: FC<LogoProps> = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const BookingLogo: FC<LogoProps> = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
...
const VrboLogo: FC<LogoProps> = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 120 40"
    fill="currentColor"
...
const HostawayLogo: FC<LogoProps> = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 160 40"
    fill="currentColor"
...
export const PLATFORM_LOGOS: { name: string; label: string; Logo: FC<{ className?: string }> }[] = [
  { name: 'airbnb', label: 'Airbnb', Logo: AirbnbLogo },
  { name: 'booking', label: 'Booking.com', Logo: BookingLogo },
  { name: 'vrbo', label: 'Vrbo', Logo: VrboLogo },
  { name: 'google', label: 'Google Hotels', Logo: GoogleLogo },
  { name: 'hostaway', label: 'Hostaway', Logo: HostawayLogo },
];
