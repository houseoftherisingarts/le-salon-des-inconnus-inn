...
# Project: Le Salon des Inconnus — Inn App
# Client:  Alex / Le Salon des Inconnus
# Stack:   React · Three.js · R3F · Firebase · Gemini AI
...
4. Report in one line: `"Vexel online. Le Salon des Inconnus — Inn App — [honest status]."`
...
Main inn management app. v0.08 — active dev.
